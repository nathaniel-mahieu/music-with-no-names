...
- **Version:** `mwno-piano-7` for the bounded sixty-second phrase, seven-attack microscope, duration/pedal ribbon, focus lenses, stabilized scale frame, correctable chord gestures, causal chord comparison, explicit voice-leading strands, and silent ghost-target layer; standardized spectral evidence reuses `mwno-sonority-1`.
