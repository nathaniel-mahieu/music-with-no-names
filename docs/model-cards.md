...
- **Version:** `mwno-piano-11` for the bounded sixty-second phrase, seven-attack microscope, duration/pedal ribbon, articulation lane, phrase-local motif transformations, focus lenses, phrase-stabilized scale frame, cyclic scale fingerprint, performed-evidence tonal gravity, silent resolution forks, correctable chord gestures, causal chord comparison, explicit voice-leading strands, silent chord targets, playable landmark paths, and the listener-reported Personal Character Map; standardized spectral evidence reuses `mwno-sonority-1`.
