...
- **Version:** `mwno-piano-4` for the seven-event HUD, stabilized scale-frame, temporal chord-gesture, and chord-neighborhood layer; standardized spectral evidence reuses `mwno-sonority-1`.
