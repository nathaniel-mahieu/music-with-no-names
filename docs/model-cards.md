...
- **Version:** `mwno-piano-10` for the bounded sixty-second phrase, seven-attack microscope, duration/pedal ribbon, articulation lane, phrase-local motif transformations, focus lenses, phrase-stabilized scale frame, cyclic scale fingerprint, performed-evidence tonal gravity, silent resolution forks, correctable chord gestures, causal chord comparison, explicit voice-leading strands, silent chord targets, and playable landmark paths; standardized spectral evidence reuses `mwno-sonority-1`.
