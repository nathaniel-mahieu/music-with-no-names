...
- **Version:** `mwno-piano-8` for the bounded sixty-second phrase, seven-attack microscope, duration/pedal ribbon, focus lenses, phrase-stabilized scale frame, cyclic scale fingerprint, performed-evidence tonal gravity, silent resolution forks, correctable chord gestures, causal chord comparison, explicit voice-leading strands, and silent chord-target layer; standardized spectral evidence reuses `mwno-sonority-1`.
