...
- **Implementation status:** Scale Lab v1.23 uses movable solfège as a culturally situated relational mnemonic, not a physical universal. It declares a 2:1 octave realized in twelve equal logarithmic slices, applies physically invariant small/medium/large gap labels, and keeps melodic distance separate from matched harmonic-spectrum interaction. Action-first copy asks learners to listen before opening measurements. Context A/Bs collect the learner’s report before interpretation. Scale-specific inner-hearing phrases require a degree choice and restore the answer in context. Piano Lab v1.26 then treats equal-tempered keys, conventional note names, scale names, staff notation, and the circle of fifths as coordinated learning overlays on top of frequency and interval relationships. Its single HUD aligns seven attacks without inferring duration, waits for distinct pitch evidence before changing its scale frame, and keeps chord labels, crunch, tonal pull, arrival, leap, and voice motion as separate evidence. Its MIDI path remains silent and analysis-only. These are teaching hypotheses, not claims that one tuning, route, chord, or perceptual response is natural or culturally universal.
