...
- **Implementation status:** Scale Lab v1.22 uses movable solfège as a culturally situated relational mnemonic, not a physical universal. It declares a 2:1 octave realized in twelve equal logarithmic slices, applies physically invariant gap labels, and keeps melodic distance separate from matched harmonic-spectrum interaction. Context A/Bs collect the learner’s report before interpretation. Scale-specific inner-hearing phrases require a degree choice and restore the answer in context. The presets are teaching examples, not a claim that one tuning or scale system is natural or culturally neutral.
