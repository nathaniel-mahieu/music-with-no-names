...
- The Piano Lab uses native buttons for every silent on-screen key, attack, and grouped chord gesture; native selects for MIDI device and chord timing granularity; text-redundant held, sustained, inherited, scale, and chord-member states; named SVG summaries for staff, frequency, fifths, interval, and evidence views; a concise polite live explanation; and line/diamond/dash shapes as well as color for perceptual traces and chord brackets.
