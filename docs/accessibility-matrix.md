...
- The Piano Lab uses native buttons for every silent on-screen key, attack, learning lens, phrase-A/B intention/capture/replay/promotion/report, Motion question, four-tap pulse action, performed-fingerprint and guided-scale action, tonal-gravity target and evidence-lane intervention, controlled-sonority recipe, interval-echo action, ghost target, chord-boundary correction, inherited-membership correction, and grouped chord gesture; native selects for MIDI device and chord timing granularity; text-redundant held, sustained, duration, pedal-tail, phrase-target/control/other-change/invariant/provenance, pulse-capture/phase/gap, performed-gap, gravity rank/component change, inherited, excluded, guided-step, controlled-baseline/replay, ghost, scale, chord-member, and voice-motion states; named visual summaries for the sixty-second phrase ribbon, five-lens A/B profile, staff, frequency, fifths, performed octave positions, paired twelve-center gravity comparison, live pulse, interval, voice-leading, and evidence views; concise polite live explanations for the HUD, phrase-B capture and one-change result, pulse capture, performed fingerprint, gravity counterfactual, guided walk, and one-note sonority comparison; and double/dotted/solid outline, fill, line, diamond, dash, cross, check, arrow, number, and text labels as well as color for A/B targets/invariants/changes/reports, baseline/intervention center bars, pulse lines and onsets, perceptual traces, voice strands, performed positions, walk progress, inherited exclusions, silent sonority references, ghost keys, and chord brackets.
