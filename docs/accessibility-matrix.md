...
- The Piano Lab uses native buttons for every silent on-screen key, attack, learning lens, Motion question, four-tap pulse action, guided-scale action, controlled-sonority recipe, interval-echo action, ghost target, chord-boundary correction, inherited-membership correction, and grouped chord gesture; native selects for MIDI device and chord timing granularity; text-redundant held, sustained, duration, pedal-tail, pulse-capture/phase/gap, inherited, excluded, guided-step, controlled-baseline/replay, ghost, scale, chord-member, and voice-motion states; named SVG summaries for the sixty-second phrase ribbon, staff, frequency, fifths, live pulse, interval, voice-leading, and evidence views; concise polite live explanations for the HUD, pulse capture, guided walk, and one-note sonority comparison; and line/diamond/dash/cross/check/arrow shapes as well as color for pulse lines and onsets, perceptual traces, voice strands, walk progress, inherited exclusions, silent sonority references, ghost keys, and chord brackets.
