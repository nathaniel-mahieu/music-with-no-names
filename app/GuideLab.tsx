...
const GLOSSARY = [
  ...
  ["semitone", "one equal-tempered piano-key step; twelve semitones double frequency and complete an octave"],
  ["interval", "the pitch distance between two sounds; semitones measure keyboard spacing, while ratio and register add physical detail"],
