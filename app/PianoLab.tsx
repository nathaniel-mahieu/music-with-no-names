...
type FocusLens = "explore" | "immersion" | "research" | "intervals" | "scales" | "chords" | "motion" | "paths" | "experience";
...
export function PianoLab() {
  ...
  const isShortHudFocus = focusLens === "immersion" || focusLens === "research";
