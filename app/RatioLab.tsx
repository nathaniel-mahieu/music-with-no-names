...
const PIANO_LENS_LABELS: Record<PianoSessionSummary["focusLens"], string> = {
  ...
  "sight-shapes": "sight-shapes-reader",
...
> = {
  ...
  voice: {
    ...
    description:
      "Start the local microphone only when you are ready. See whether to move up or down, watch the recent pitch trail settle around the target, and keep pitch accuracy, periodic clarity, and steadiness separate.",
    ...
    <main className="app-shell">
      ...
      <header className="site-header">
        ...
        <div className="header-status">
          ...
          {activeLab === "guide" ? "start here" : activeLab === "personal" ? "personal lens" : `${activeLab} lab`} · v2.13
        </div>
      </header>
